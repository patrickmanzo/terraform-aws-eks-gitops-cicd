# --------------------------------------------------------------------------------------
# Full Deployment Configuration - All modules enabled
# --------------------------------------------------------------------------------------
...
# GitHub configuration (required for ArgoCD and Jenkins)
...
# rds_password should be set via environment variables or secrets
...
# S3 Configuration
app_bucket_name = "finance-app-data"

# Bastion Configuration
key_name = "your-key-pair-name" # Optional SSH key for bastion access
